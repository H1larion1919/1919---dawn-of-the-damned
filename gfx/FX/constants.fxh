...
static const float GB_OPACITY_NEAR = 0.68f;
static const float GB_OPACITY_FAR = 0.95f;
static const float TERRAIN_FLATTEN_START = 0.44f;
static const float TERRAIN_FLATTEN_END = 0.98f;
static const float WATER_DEPTH_DEEP_HEIGHT = 0.930f;
static const float WATER_DEPTH_SHALLOW_HEIGHT = 0.985f;
static const float WATER_DEPTH_GRADIENT_DEEP = 0.22f;
static const float WATER_DEPTH_GRADIENT_SHALLOW = 0.50f;
static const float WATER_DEPTH_OVERLAY_STRENGTH = 0.80f;

// A restrained scene-wide warm grade. This is deliberately much weaker than
// the former red land mist and water tint.
static const float3 SCREEN_RED_TINT_MULTIPLY = float3( 1.0f, 0.965f, 0.965f );
static const float3 SCREEN_RED_TINT_ADD = float3( 0.008f, 0.001f, 0.001f );
static const float SCREEN_RED_TINT_STRENGTH = 0.35f;
